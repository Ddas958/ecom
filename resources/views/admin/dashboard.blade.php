    ...
    <div class="col-lg-6">
      <div class="card">
        ...
        <div class="comment-widgets scrollable">
          ...
          <div class="d-flex flex-row comment-row">
            <div class="p-2">
              <img src="{{ asset('/assets/images/users/5.jpg') }}" alt="user" width="50" class="rounded-circle" />
            </div>
            <div class="comment-text w-100">
              ...
              <li class="list-group-item todo-item" data-role="task">
                <div class="form-check">
                  ...
                  <label class="form-check-label w-100 mb-0 todo-label" for="customCheck">
                    <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                    <span class="badge rounded-pill bg-danger float-end">Today</span>
                  </label>
                </div>
                <ul class="list-style-none assignedto">
                  <li class="assignee">
                    <img class="rounded-circle" width="40" src="{{ asset('/assets/images/users/1.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave" />
                  </li>
                  <li class="assignee">
                    <img class="rounded-circle" width="40" src="{{ asset('/assets/images/users/2.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica" />
                  </li>
                  <li class="assignee">
                    <img class="rounded-circle" width="40" src="{{ asset('/assets/images/users/3.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka" />
                  </li>
                  <li class="assignee">
                    <img class="rounded-circle" width="40" src="{{ asset('/assets/images/users/4.jpg') }}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina" />
                  </li>
                </ul>
              </li>
              <li class="list-group-item todo-item" data-role="task">
                <div class="form-check">
                  ...
                  <label class="form-check-label w-100 mb-0 todo-label" for="customCheck1">
                    <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy text of the printing</span>
                    <span class="badge rounded-pill bg-primary float-end">1 week </span>
                  </label>
                </div>
      ...
      <div class="card">
        ...
        <ul class="list-style-none">
          <li class="d-flex no-block card-body">
            ...
            <div>
              <a href="#" class="mb-0 font-medium p-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
          ...
          <li class="d-flex no-block card-body border-top">
            ...
            <div>
              <a href="#" class="mb-0 font-medium p-0"> I am alwayse here if you have any question</a>
      ...
      <div id="accordian-4">
        <div class="card mt-4">
          ...
          <div id="Toggle-1" class="collapse show multi-collapse">
            <div class="card-body widget-content"> This box is opened by default, paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end. </div>
          </div>
          ...
          <div id="Toggle-2" class="multi-collapse collapse" style="">
            <div class="card-body widget-content"> This box is now open </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="tab-content tabcontent-border">
          ...
          <div class="tab-pane p-20" id="profile" role="tabpanel">
            <div class="p-20">
              <img src="{{ asset('/assets/images/background/img4.jpg') }}" class="img-fluid" />
              <p class="mt-2"> And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.. </p>
            </div>
          </div>
